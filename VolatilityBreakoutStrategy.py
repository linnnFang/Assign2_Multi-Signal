...
class VolatilityBreakoutStrategy:
    """
    Buy 1 share if daily return > rolling N-day std dev on day t; trade at t+1.
    """
    def __init__(self, initial_cash, tickers, lookback=20,
    ...
    def run(self):
        ...
        sig_t = (ret > vol) & ret.notna() & vol.notna()
